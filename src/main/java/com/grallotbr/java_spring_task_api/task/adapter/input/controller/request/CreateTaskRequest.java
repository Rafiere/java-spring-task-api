...
public record CreateTaskRequest(@JsonProperty("task_name")
    ...
    public record CreateSubtaskRequest(@JsonProperty("subtask_name")
                                       ...
                                       @NotBlank(message = "Subtask status is required")
